        ...
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                <div class="section-heading">
                    <h6>Keunggulan</h6>
                    <h4>Jasa Pembuatan Web Specialsync</h4>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="service-item">
                    ...
                    <h4>RELIABLE</h4>
                    <p>Telah teruji selama lebih dari 17 tahun dalam menyediakan layanan profesional berbasis Web.</p>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="service-item">
                    ...
                    <p>Layanan maintenance meskipun Web sudah diserah terimakan ke Client.</p>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="service-item">
                    <i class="fas fa-charging-station"></i>
                    <h4>PERSONALIZE SUPPORT</h4>
                    <p>Tersedia dedicated Technical Support yang akan membantu menyelesaikan permasalahan.</p>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="service-item">
                    ...
                    <h4>FRIENDLY SEO</h4>
                    <p>Paket bisnis ke atas sudah SEO friendly. Disamping itu tersedia layanan Add-On SEO
                        premium.</p>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="service-item">
                    ...
                    <h4>DATA CENTER DI JAKARTA</h4>
                    <p>Sehingga kecepatan akses akan lebih tinggi dan stabil.
                    </p>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="service-item">
                    ...
                    <h4>SECURE</h4>
                    <p>Data yang tersimpan di server lebih aman dan backup server ada
                        di gedung terpisah.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="simple-cta">
    <div class="container">
        <div class="row">
            <div class="col-lg-5">
                <h4>Jasa <em>Pembuatan</em><strong> Website</strong> Profesional</h4>
            </div>
            <div class="col-lg-7">
                <div class="buttons">
